...
const RETAIL_PARTNERS = [
  { name: 'WinMart & WinMart+', logo: winmartLogo?.src || winmartLogo, note: 'Hệ thống siêu thị toàn quốc' },
  { name: 'GO! & Tops Market', logo: goLogo?.src || goLogo, note: 'Đại siêu thị & chuỗi bán lẻ' },
  { name: 'Lotte Mart', logo: lotteLogo?.src || lotteLogo, note: 'Chuỗi đại siêu thị quốc tế', className: 'max-h-12 scale-110' },
  { name: 'Circle K', logo: circleKLogo?.src || circleKLogo, note: 'Chuỗi cửa hàng tiện lợi 24/7' },
  { name: 'GS25', logo: gs25Logo?.src || gs25Logo, note: 'Chuỗi tiện lợi chuẩn Hàn Quốc' },
  { name: 'K-Market', logo: kmartLogo?.src || kmartLogo, note: 'Hệ thống thực phẩm xuất nhập khẩu' },
  { name: 'Bách Hóa Xanh', logo: bachHoaXanhLogo?.src || bachHoaXanhLogo, note: 'Chuỗi bán lẻ thực phẩm & tiêu dùng' },
]
