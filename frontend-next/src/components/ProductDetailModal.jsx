      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-full flex flex-col md:flex-row overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="w-full md:w-2/5 lg:w-1/2 bg-white p-4 md:p-8 flex flex-col items-center justify-center relative min-h-[200px] md:min-h-0 border-b md:border-b-0 md:border-r border-haq-border">
          ...
          <div className="relative w-full max-h-[38vh] max-w-[38vh] md:max-h-none md:max-w-none aspect-square rounded-2xl overflow-hidden bg-white border border-haq-border flex items-center justify-center shadow-sm">
            {/* Tag */}
            {product.tag && (
              <div className="absolute top-3.5 left-3.5 sm:top-4 sm:left-4 z-30 bg-[#16A34A] text-white text-xs font-heading font-bold uppercase tracking-wider px-3 py-1.5 rounded-full shadow-md pointer-events-none select-none">
                {product.tag}
              </div>
            )}
