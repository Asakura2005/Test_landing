...
const SLIDES = [
  { image: heroBanner1?.src || heroBanner1, alt: 'HAQ FOOD - Hệ Sinh Thái Sản Phẩm' },
  { image: heroBanner2?.src || heroBanner2, alt: 'HAQ FOOD - Bánh Đậu Xanh Tươi Truyền Thống' },
  { image: heroBanner3?.src || heroBanner3, alt: 'HAQ FOOD - Hương Vị Việt Tinh Túy' },
]
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Clean Bottom Indicator Dots — Accessible 48x48 touch targets */}
      <div className="absolute bottom-2 sm:bottom-8 left-1/2 -translate-x-1/2 z-30 flex items-center pointer-events-auto">
        {SLIDES.map((_, i) => (
          <button
            ...
            type="button"
            onClick={(e) => goTo(i, e)}
            className="w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center cursor-pointer transition-transform hover:scale-110"
