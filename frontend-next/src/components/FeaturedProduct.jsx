        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 relative">
            <div className="relative aspect-16/10 rounded-3xl overflow-hidden shadow-2xl border border-haq-border">
              <img
                src={signatureImg?.src || signatureImg}
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 mt-4">
              <Link
                href={getProductDetailUrl('banh-trang-tron-sa-te-tom', language)}
              ...
              <Link
                href={getProductDetailUrl('banh-trang-say-gion-vi-tom', language)}
                onClick={() => trackProductClick({
              ...
              <Link
                href={getProductDetailUrl('banh-trang-say-gion-vi-bo', language)}
                onClick={() => trackProductClick({
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <Link
                href={`${getProductsPageUrl(language)}?category=banh-trang`}
              ...
              <Link
                href={`${getContactUrl(language)}?type=oem`}
