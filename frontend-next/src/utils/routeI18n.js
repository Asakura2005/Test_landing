...
export function getEquivalentRoute(currentPath = '/', targetLang = 'vi') {
  ...
  const careersDetailMatch = normalized.match(/^(?:\/en\/careers|\/ko\/careers|\/zh\/careers|\/tuyen-dung|\/en\/tuyen-dung|\/ko\/tuyen-dung|\/zh\/tuyen-dung)\/([^/]+)$/)
  ...
  // 4. Match against static definitions
...
/**
 * Helper sinh đường dẫn chi tiết tuyển dụng theo ngôn ngữ
 */
