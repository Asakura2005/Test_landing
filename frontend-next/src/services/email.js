...
const API_BASE_URL = process.env.NEXT_PUBLIC_BACKEND_API_URL || 'https://test-landing-l1xv.onrender.com/api'
if (!API_BASE_URL) {
  console.warn('WARNING: NEXT_PUBLIC_BACKEND_API_URL not configured. Email notifications will not work.')
}
