...
export default function BrandVisualSection() {
  return (
    <section className="relative w-full py-28 sm:py-36 bg-[#0C1E15] text-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-site px-4 sm:px-6 lg:px-12">
        <div className="max-w-3xl">
          ...
          {/* Headline */}
          <h2 className="font-heading font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight uppercase leading-[1.1] mb-4">
            TỪ NÔNG SẢN VIỆT <br className="hidden sm:block" />
            <span className="text-[#C89B3C]">VƯƠN TẦM CHÂU Á</span>
          </h2>

          {/* Markets Line */}
          <div className="font-heading text-sm sm:text-base font-bold uppercase tracking-wider text-[#16A34A] mb-6">
            VIỆT NAM · HÀN QUỐC · ĐÀI LOAN
          </div>

          {/* Editorial Description */}
          <p className="text-sm sm:text-base lg:text-lg text-white/85 leading-relaxed max-w-2xl mb-10 font-normal">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2.5 bg-[#16A34A] hover:bg-[#13863d] text-white text-xs sm:text-sm font-heading font-bold uppercase tracking-wider px-8 py-4 rounded-full transition-all duration-300 shadow-md hover:shadow-lg"
          >
