        ...
        <div ref={ref} className="reveal flex flex-col">
          ...
          <div className="flex items-center gap-2 mb-3">
            <span className="font-mono text-xs font-bold tracking-[0.25em] text-haq-red uppercase">
              03 / DOANH NGHIỆP (ABOUT HAQ FOOD)
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <h2 className="font-heading font-black text-3xl sm:text-4xl lg:text-5xl text-haq-ink tracking-tight uppercase leading-[1.08]">
                CHẤT LƯỢNG <br />
              ...
              <div className="space-y-4 text-sm sm:text-base text-haq-ink/80 leading-relaxed">
                <p>
                  <strong>CÔNG TY CỔ PHẦN HAQ HÀ NỘI</strong> (thương hiệu <strong>HAQ FOOD</strong>) được thành lập năm 2021 tại Hà Nội, hoạt động chính trong lĩnh vực sản xuất và phân phối các sản phẩm thực phẩm, đồ ăn vặt đóng gói.
                </p>
                <p>
                  HAQ FOOD tập trung phát triển các dòng sản phẩm đồ ăn vặt mang đậm phong vị ẩm thực đường phố Việt Nam, kết hợp công nghệ chế biến hiện đại đạt chuẩn <strong>ISO 22000</strong> và <strong>HACCP</strong>, đảm bảo chất lượng đồng nhất và an toàn cho người tiêu dùng.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-black/5">
                <div className="p-4 rounded-2xl bg-haq-bone border border-black/5">
                  ...
                  <div className="text-xs text-haq-ink/70">
                    Hệ thống quản lý chất lượng quốc tế ISO 22000 & HACCP.
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-haq-bone border border-black/5">
                  ...
                  <div className="text-xs text-haq-ink/70">
                    Đáp ứng các đơn hàng lớn và gia công OEM / ODM theo yêu cầu.
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2">
                ...
                >
                  <span>XEM CÂU CHUYỆN HAQ FOOD</span>
                  <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </Link>
              </div>
            </div>

            {/* Right: Factory Facility Real Image (Spans 6 cols) */}
