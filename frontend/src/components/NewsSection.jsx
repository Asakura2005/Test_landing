      ...
      <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <div>
            <Link
              to="/tin-tuc"
              className="inline-flex items-center gap-2 bg-haq-bone hover:bg-black/5 text-haq-ink text-xs font-heading font-extrabold uppercase tracking-wider px-6 py-3 rounded-full transition-all border border-black/10"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 group bg-haq-bone rounded-3xl overflow-hidden border border-black/5 hover:border-black/20 shadow-2xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
            ...
            <div className="p-6 sm:p-8 flex flex-col justify-between flex-1">
              <div>
                <div className="flex items-center gap-2 text-xs font-mono text-haq-ink/50 mb-2">
                ...
                <p className="text-xs sm:text-sm text-haq-ink/75 leading-relaxed mt-3">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            {SIDE_NEWS.map((item) => (
              <div
                key={item.id}
                className="group bg-haq-bone rounded-3xl p-6 border border-black/5 hover:border-black/20 shadow-2xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between flex-1"
              >
                <div>
                  <div className="flex items-center justify-between text-[10px] font-mono text-haq-ink/50 mb-2">
