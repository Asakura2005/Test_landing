      ...
      <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <div className="shrink-0">
            <Link
              to="/lien-he"
              className="inline-flex items-center gap-2 bg-haq-red hover:bg-haq-ink text-white text-xs font-heading font-extrabold uppercase tracking-wider px-7 py-3.5 rounded-full transition-all duration-200 shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="p-6 rounded-3xl bg-white border border-black/5 hover:border-black/15 shadow-2xs transition-all">
