      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-haq-ink text-white">
        <div className="mx-auto max-w-site px-6 md:px-12">
          <h1 className="font-heading font-extrabold text-4xl md:text-6xl tracking-tight">
            Tin Tức & <span className="text-haq-gold">Tuyển Dụng</span>
          </h1>
          <p className="mt-6 text-xl text-white/70 max-w-2xl">
            Cập nhật tin tức mới nhất từ HAQ Food và các cơ hội tuyển dụng.
          </p>
        </div>
      </section>
      <section className="flex-1 py-20">
        <div className="mx-auto max-w-site px-6 md:px-12 text-center">
          <div className="bg-white border border-black/5 p-16 max-w-2xl mx-auto">
            <p className="text-haq-ink/50 text-lg font-medium">Nội dung trang Tin tức sẽ được cập nhật sau.</p>
            <p className="text-haq-ink/30 text-sm mt-4">Bạn có thể chỉnh sửa nội dung tại file NewsPage.jsx</p>
          </div>
        </div>
      </section>
      <Footer />
