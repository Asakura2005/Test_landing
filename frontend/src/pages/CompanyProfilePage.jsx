          ...
          <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-7 bg-white rounded-2xl border border-haq-border p-6 sm:p-8 shadow-2xs">
                <h3 className="font-heading font-bold text-base text-haq-ink uppercase pb-4 mb-2 border-b border-haq-border flex items-center justify-between">
                  <span>HỒ SƠ ĐĂNG KÝ DOANH NGHIỆP</span>
                  <span className="text-xs font-mono font-normal text-haq-text-secondary">EST. 2021</span>
                </h3>
                ...
                <dl className="divide-y divide-haq-border text-xs sm:text-sm">
                  ...
                  <div className="py-3.5 grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4">
                    ...
                    <dd className="sm:col-span-2 text-haq-ink">
                      <span className="font-mono font-bold">0109675204</span>
                      <span className="text-xs text-haq-text-secondary ml-1.5">— Sở Kế hoạch & Đầu tư TP. Hà Nội cấp</span>
                    </dd>
                  </div>
                  ...
                  <div className="py-3.5 grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4">
                    ...
                    <dd className="sm:col-span-2 text-haq-ink leading-relaxed">
                      Sản xuất, chế biến sâu và bảo quản thực phẩm: Bánh tráng sấy giòn cao cấp (HOKI), bánh nướng hạnh nhân, bánh sữa dừa, bánh đậu xanh tươi và nông sản sấy khô.
                    </dd>
                  </div>
                  ...
                  <div className="py-3.5 grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4">
                    ...
                    <dd className="sm:col-span-2 text-haq-ink leading-relaxed">
                      Chuỗi bán lẻ hiện đại (WinMart, Circle K, GS25, Bách Hóa Xanh, K-Market...), đại lý phân phối toàn quốc và xuất khẩu (Hàn Quốc, Đài Loan).
                    </dd>
                  </div>
                  ...
                  <div className="py-3.5 grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4">
                    ...
                    <dd className="sm:col-span-2 text-haq-ink leading-relaxed">
                      Cung ứng sỉ, Gia công sản phẩm theo đơn đặt hàng (OEM/ODM), Gia công nhãn hàng riêng (Private Label).
                    </dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="overflow-hidden rounded-2xl border border-haq-border bg-white shadow-2xs">
                  ...
                  <div className="p-4 bg-haq-cream/50 border-t border-haq-border text-xs text-haq-text-secondary leading-relaxed">
                    <span className="font-semibold text-haq-ink">Cơ sở sản xuất HAQ FOOD tại Hà Nội:</span> Quy trình kiểm soát khép kín từ tuyển chọn nguyên liệu, chế biến sấy sạch đối lưu đến đóng gói bao bì màng nhôm tiệt trùng.
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl border border-haq-border bg-white shadow-2xs flex items-center justify-between gap-4">
                  <div>
                    <div className="font-heading font-bold text-xs uppercase text-haq-ink">
                      Liên hệ hợp tác phân phối & OEM
                    </div>
                    <div className="text-xs text-haq-text-secondary mt-0.5">
                      Tiếp nhận yêu cầu báo giá sỉ, hợp đồng gia công và gửi mẫu thử.
                    </div>
                  </div>
                  <Link
                    to="/lien-he"
            ...
            <div className="mt-12 sm:mt-16 pt-10 border-t border-haq-border">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="p-6 rounded-2xl bg-white border border-haq-border shadow-2xs space-y-2">
                  <div className="font-heading text-xs font-bold text-[#C89B3C] uppercase tracking-wider">
                    01 · CÔNG NGHỆ SẢN XUẤT
                  </div>
                  <h4 className="font-heading font-bold text-base text-haq-ink uppercase">
                    Sấy Sạch Đối Lưu Khép Kín
                  </h4>
                  <p className="text-xs text-haq-text-secondary leading-relaxed">
                    Ứng dụng công nghệ sấy tuần hoàn nhiệt kín, kiểm soát chính xác nhiệt độ và độ ẩm, giữ trọn độ giòn xốp tự nhiên mà không tồn dư dầu chiên.
                  </p>
                </div>

                <div className="p-6 rounded-2xl bg-white border border-haq-border shadow-2xs space-y-2">
                  <div className="font-heading text-xs font-bold text-[#C89B3C] uppercase tracking-wider">
                    02 · NGUỒN NGUYÊN LIỆU
                  </div>
                  <h4 className="font-heading font-bold text-base text-haq-ink uppercase">
                    Liên Kết Nông Sản Bản Địa
                  </h4>
                  <p className="text-xs text-haq-text-secondary leading-relaxed">
                    Ưu tiên kết nối và thu mua nguồn nông sản Việt Nam sạch, rõ ràng nguồn gốc xuất xứ, kiểm nghiệm định kỳ các chỉ tiêu vi sinh và an toàn thực phẩm.
                  </p>
                </div>

                <div className="p-6 rounded-2xl bg-white border border-haq-border shadow-2xs space-y-2">
                  <div className="font-heading text-xs font-bold text-[#C89B3C] uppercase tracking-wider">
                    03 · NĂNG LỰC CUNG ỨNG B2B
                  </div>
                  <h4 className="font-heading font-bold text-base text-haq-ink uppercase">
                    Gia Công OEM / ODM Linh Hoạt
                  </h4>
                  <p className="text-xs text-haq-text-secondary leading-relaxed">
                    Hỗ trợ đối tác chuỗi bán lẻ và xuất khẩu từ khâu R&D phát triển hương vị, gửi mẫu thử, thiết kế quy cách đóng gói đến hoàn tất hồ sơ tự công bố.
                  </p>
                </div>
              </div>
            </div>
