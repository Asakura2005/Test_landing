...
import { Scale, ChevronRight, Phone, Mail, ShieldAlert, FileText, CheckCircle2 } from 'lucide-react'
...
export default function TermsOfServicePage() {
  ...
  const data = POLICY_TRANSLATIONS.terms[language] || POLICY_TRANSLATIONS.terms.vi
